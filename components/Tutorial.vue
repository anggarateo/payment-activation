...
<template>
  <div class="relative flex flex-col gap-8 items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
    ...
    <NuxtLink
      class="rounded-md p-2 bg-green-500 text-white hover:bg-green-600"
      to="/activation"
    >
      Aktifkan Pembayaran
    </NuxtLink>
